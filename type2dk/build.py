...
elf=root/'test.elf'; raw=root/'test.raw'
subprocess.run([a.zig,'cc','-target','thumb-freestanding-eabi','-mcpu=cortex_m4',
 ...
 str(root/'src/main.c'),str(root/'src/startup.c'),'-Wl,-T,'+str(root/'src/link.ld'),
...
out=root/'2dk_i2c_diag_v2.bin'; out.write_bytes(b); raw.unlink()
